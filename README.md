...
The app is split into deployable web, citizen, API, and batch services. The API uses configured AI providers for intake processing and marks failed model calls for retry instead of generating fake deterministic decisions. The code keeps clear seams for Google Cloud Speech-to-Text, Vision OCR, Translation, Vertex AI embeddings, BigQuery GIS, Pub/Sub, Cloud Storage, GDELT, X, and official Indian data APIs. Kubernetes manifests are generated by Helm and reconciled by Argo CD.
