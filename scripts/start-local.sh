...
export RAG_INGEST_PATHS="${RAG_INGEST_PATHS:-services/rag-api/fixtures/loksetu/rag-architecture.md,services/rag-api/fixtures/loksetu/delhi-constituency-intelligence.md,services/rag-api/fixtures/loksetu/citizen-feedback-digest.md,services/rag-api/fixtures/bihar/census-bihar-2011.md}"
