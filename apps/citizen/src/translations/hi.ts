const hi: Record<string, string> = {
  ...
  "Report a local issue in seconds through the protected LokSetu intake.": "सुरक्षित लोकसेतु प्रणाली से कुछ ही सेकंड में अपनी स्थानीय समस्या दर्ज करें।",
  ...
  "Your name stays private. AI removes personal details before your MP sees it.": "आपका नाम गोपनीय रहता है। सांसद के देखने से पहले AI व्यक्तिगत जानकारी हटा देता है।",
  "My reward total": "मेरा कुल इनाम",
  "Show my reward total": "मेरा कुल इनाम दिखाएँ",
  "See cumulative reward points, milestone reached, and pending reports.": "कुल इनाम अंक, प्राप्त पड़ाव और लंबित रिपोर्ट देखें।",
  "No processed rewards yet. Submitted reports appear here after AI batch scoring.": "अभी कोई इनाम संसाधित नहीं हुआ। AI बैच स्कोरिंग के बाद रिपोर्ट यहाँ दिखेंगी।",
  ...
  "Hindi, Tamil, Bangla, Marathi, English — any language": "हिन्दी, तमिल, बांग्ला, मराठी, अंग्रेज़ी — कोई भी भाषा",
  "Listen once before submitting. Record again if needed.": "जमा करने से पहले एक बार सुनें। ज़रूरत हो तो दोबारा रिकॉर्ड करें।",
  "Describe the problem": "समस्या का विवरण दें",
  "E.g. School toilets are broken and classrooms flood after rain.": "जैसे: स्कूल के शौचालय टूटे हैं और बारिश के बाद कक्षाओं में पानी भर जाता है।",
  ...
  "Pick any Indian language. Your voice or text can still be in any language — this sets your preference.": "कोई भी भारतीय भाषा चुनें। आपकी आवाज़ या टेक्स्ट किसी भी भाषा में हो सकता है — यह सिर्फ़ आपकी पसंद तय करता है।",
  ...
  "Aadhaar access uses 12-digit format check only.": "आधार पहुँच केवल 12-अंकों के प्रारूप की जाँच करती है।",
